...
export const DEFAULT_ACCESS_MODE: AccessMode = 'private_prelaunch'
export const ACTIVE_ACCESS_MODES: readonly AccessMode[] = [DEFAULT_ACCESS_MODE]
export const FUTURE_PUBLIC_ACCESS_MODES: readonly AccessMode[] = ['invite_only', 'public_product']
