    ...
    <main className="min-h-screen bg-background text-foreground p-6">
      <div className="mx-auto max-w-4xl rounded-xl border border-border bg-card p-6">
        ...
        <div className="mt-6 flex gap-3">
          <button className="rounded-md bg-primary px-4 py-2 text-primary-foreground font-semibold" onClick={() => navigateTo('/profile')}>
            {t('dashboard.openProfile')}
          </button>
          <button className="rounded-md border border-border px-4 py-2" onClick={() => navigateTo('/settings')}>
