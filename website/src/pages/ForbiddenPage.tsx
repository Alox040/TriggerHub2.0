...
export const ForbiddenPage = ({ onNavigate }: ForbiddenPageProps) => (
  <main className="min-h-screen bg-[#0b0b0c] text-white flex items-center justify-center p-6">
    <div className="w-full max-w-md rounded-xl border border-red-500/30 bg-zinc-900/80 p-6">
      ...
      <p className="text-sm text-zinc-300 mt-3">Your current account is not allowed to access this page.</p>
      <button
        className="mt-6 rounded-md border border-zinc-500 px-4 py-2"
